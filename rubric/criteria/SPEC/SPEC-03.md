...
("Agent-authored" is defined in the glossary and entails that the attribution is grounded in recorded evidence, not inference. The operational check that the recording exists is [PROV-01](../PROV/PROV-01.md).)
