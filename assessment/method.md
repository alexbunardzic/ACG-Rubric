...
- **Binary-per-change** (e.g. [PROV-01](../rubric/criteria/PROV/PROV-01.md), [HUMAN-01](../rubric/criteria/HUMAN/HUMAN-01.md)) — any single failure in the sample fails the criterion. There is no percentage-passing threshold; the sample is not averaged.
